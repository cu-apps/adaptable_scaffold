...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return AdaptableScaffold(
      ...
      tabBarMoreBuilder: (navItems, numberOfTabsVisible, hideTabBar, onNavigationItemPressed) =>
        TabBarMorePage(navItems, numberOfTabsVisible, onNavigationItemPressed, hideTabBar)
    );
  }
}
                ...
                .map((e) => SizedBox(
                      ...
                      child: Padding(
                        ...
                        child: Card(
                            color: color,
                            child: ListTile(
                              title: Text("Random title " + (e + 1).toString(),
